...
* **Notification throttling**: Consecutive network calls within a 5-second window silently update the notification content without re-alerting. After 5 seconds, the next call triggers another heads-up.
